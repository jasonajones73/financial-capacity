## Purpose: Retrieve Per Capita Income data from census API
## Author: Jason Jones
...
write_rds(tracts_sf, "data/per_capita_income/pci_sf.rds")
write_rds(county_deatiled_clean, "data/per_capita_income/pci_county.rds")
write_rds(places_detailed_clean, "data/per_capita_income/pci_places.rds")

write_csv(county_deatiled_clean, "data/per_capita_income/pci_county.csv")
write_csv(places_detailed_clean, "data/per_capita_income/pci_places.csv")
write_csv(tracts_sf, "data/per_capita_income/pci_tracts.csv")
