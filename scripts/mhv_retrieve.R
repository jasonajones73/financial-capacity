## Purpose: Retrieve Median Home Value data from census API
## Author: Jason Jones
...
write_rds(tracts_sf, "data/median_home_value/mhv_sf.rds")
write_rds(county_deatiled_clean, "data/median_home_value/mhv_county.rds")
write_rds(places_detailed_clean, "data/median_home_value/mhv_places.rds")

write_csv(county_deatiled_clean, "data/median_home_value/mhv_county.csv")
write_csv(places_detailed_clean, "data/median_home_value/mhv_places.csv")
write_csv(tracts_sf, "data/median_home_value/mhv_tracts.csv")
