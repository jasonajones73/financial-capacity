...
pci_county %>%
  ...
  geom_tile(aes(str_remove(NAME, "County, North Carolina|County, Tennessee|County, South Carolina"),
                concept, fill = estimate), color = "white") +
  scale_fill_gradient("Estimate",high = "light grey", low = "#00ad68",
                      na.value = "white", labels = scales::dollar_format()) +
  geom_text(aes(str_remove(NAME, "County, North Carolina|County, Tennessee|County, South Carolina"),
                concept, label = scales::dollar(estimate)), size = 2) +
  theme_minimal() +
...
mfi_county %>%
  ...
  ggplot() +
  geom_tile(aes(str_remove(NAME, "County, North Carolina|County, Tennessee|County, South Carolina"),
                str_remove(concept, " Householder"), fill = estimate), color = "white") +
  scale_fill_gradient("Estimate",high = "light grey", low = "#00ad68",
                      na.value = "white", labels = scales::dollar_format()) +
  geom_text(aes(str_remove(NAME, "County, North Carolina|County, Tennessee|County, South Carolina"),
                str_remove(concept, " Householder"), label = scales::dollar(estimate)), size = 2) +
  theme_minimal() +
  theme(text = element_text(family = "Roboto"),
  panel.background = element_blank(),
  axis.ticks = element_line(color = "grey"),
...
bach_county %>%
  ...
  geom_tile(aes(str_remove(county, "County, North Carolina|County, Tennessee|County, South Carolina"),
                concept, fill = pct), color = "white") +
  scale_fill_gradient("Estimate",high = "light grey", low = "#00ad68",
                      na.value = "white", labels = scales::percent_format(accuracy = 0.01)) +
  geom_text(aes(str_remove(county, "County, North Carolina|County, Tennessee|County, South Carolina"),
                concept, label = scales::percent(pct, accuracy = 0.01)), size = 2) +
  theme_minimal() +
  theme(text = element_text(family = "Roboto"),
  panel.background = element_blank(),
  axis.ticks = element_line(color = "grey"),
